...
```{r}
expenditures %>% 
  pivot_longer(-expenditure, # dont move expenditure
               names_to = "year", # new variable year
               values_to = "bn_dollars") # moving values into bn_dollars, data frame now longer (now if you want to make a plot, x value will be year and y value is bn_dollars)
```
