...
R is an open source scripting language and RStudio is the GUI used to interact with R. GitHub is a website used by programmers to upload and share code/files easily. It is also used to manage files in one place. 
